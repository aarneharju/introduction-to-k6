...
export default function () {
  group("Main page", function () {
    let response = http.get(
      "https://run.mocky.io/v3/7e4d2a14-1401-4337-be84-884299ef4cab?mocky-delay=5000ms"
    );
    check(response, { "status is 200": (res) => res.status === 200 });

    group("Assets", function () {
      http.get(
        "https://run.mocky.io/v3/7e4d2a14-1401-4337-be84-884299ef4cab?mocky-delay=1000ms"
      );
      http.get(
        "https://run.mocky.io/v3/7e4d2a14-1401-4337-be84-884299ef4cab?mocky-delay=1000ms"
      );
